...
const Section2Home = () => {
  const vidUrl = "https://www.youtube.com/watch?v=hbxpjh4wvmo";
  return (
        ...
        <div className=" w-full   ">
          <div className=" flex flex-col mt-3 m-2">
            ...
            <p className=" text-justify mt-3 text-md  ">
              Ofrecemos a nuestros clientes la experiencia única de trabajos de
              calidad. Desde la conceptualización hasta la entrega final
            </p>
          </div>
        </div>
      ...
      <div className=" flex flex-col lg:flex-row  items-center lg:m-10 gap-20">
        <div className=" w-full   ">
          <div className=" flex flex-col mt-3 m-2">
            ...
            <p className=" text-justify mt-3 text-md  ">
              Recientemente, tuvimos el privilegio de trabajar en la
              optimización de la sala de sistemas de nuestro colegio asociado.
              Nuestro enfoque se centró en maximizar la eficiencia y la
              funcionalidad, asegurando que cada elemento tecnológico
              contribuyera al entorno educativo de manera significativa.
            </p>
          </div>
          <div>
            <TrabajosCarrusel />
          ...
          <div>
            ...
            <p>
              La satisfacción del cliente es nuestra mayor recompensa! En este
              video, <strong>Carlos Londoño</strong> profesor de primaria y
              usuario de los computadores de la sala restaurada comparte su
